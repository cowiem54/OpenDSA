...
(function() {
    ...
    var booth_ex1 = {	// Name of export object
	userInput: null,  // Boolean: Tells us if user ever did anything

	// Initialise the exercise
	initJSAV: function(arr_size) {
	    booth_ex1.userInput = false;
	    av = new JSAV("Booth_ex1", {animationMode: "none"});
	...
	booth_ex1.userInput = true;
    }
    // Export name used here
    window.booth_ex1 = window.booth_ex1 || booth_ex1;
}());
